            ...
            <Table>
              ...
              <TableBody>
                {c?.officers.map((o) => {
                  ...
                  const net = o.net_cash_flow ?? (totalReceived - disb);
                  return (
                ...
                {c && (() => {
                  ...
                  const gNet = c.grand.net_cash_flow ?? (gTotalReceived - gDisb);
                  return (
                    <TableRow className="bg-muted/30 font-semibold">
                      ...
                      <TableCell className="text-right">
                        <TrendCell label="Total arrear collected" value={gArr} extractor={(d) => d.officers?.arrear_collected ?? null} anchor={state.anchor} officerId={state.officerId || undefined} />
                      </TableCell>
